        ...
        <form id="ORDER_FORM_ID_NEW" name="<?=$FORM_NAME?>" method='post' action=''>
            ...
            <div class="orders_block">
                ...
                <div id="order_form_id">
                    ...
                    ?>
 <p style="color:red;">При заказа товара на сумму свыше 5000 руб доставка по России бесплатно. </p>
    <p style="color:red;">При оплате товара безналичным платежом скидка 5%. </p><br />
                    <?
