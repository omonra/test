...
else
{
    ...
    <?if(!$arResult["disc"]):?><p style="color:red;">Скидка 5% за полную предоплату заказа. </p>
    <?endif?>
    <br />
