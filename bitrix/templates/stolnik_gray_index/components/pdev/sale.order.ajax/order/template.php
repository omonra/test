...
<div class="b-basket">
    ...
    <?if (is_array($arResult['DELIVERY']) && count($arResult['DELIVERY']) > 0):?>
        ...
        <div class="b-form__right" style="clear: both;margin-top: 30px;<?=(isset($_GET['test']) && $_GET['test']==1)?"":"display:none;"?>">
            <div class="b-info">
                <div class="b-info-content">
                    <img src="/upload/iblock/498/4981ef093bf8b2da16495719d48b97d3.png"/>
                    <div class="b-info-text">Передумали? Верните деньги в течении 14 дней</div>
                </div>                
            </div>
            <div class="b-info">
                <div class="b-info-content">
                    <img src="/upload/iblock/516/5169f93ab384f612890d10ba6204189c.png"/>
                    <div class="b-info-text">Бесплатная доставка курьером по всей России<div style="font-size:0.8em">На заказы от 5000 руб. </div></div>                
                </div>                
            </div>
            <div class="b-info">
                <div class="b-info-content">
...
<table class="b-summary">
    <tr>
        <td class="text-left">
            При заказе товара на сумму свыше 5000 руб доставка Почтой России и "СДЕК" <br/> бесплатно.
            <div class="b-promo">
        ...
        <td class="text-right bold g-clear">
            ...
            <input onClick="submitForm('Y'); return false;" class="btn" value="Оформить покупку" type="submit"/>
