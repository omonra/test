$(document).ready(function () {
    ...
    var registerSuccess = $(".registerSuccessInput").val();
    if(registerSuccess == "y")
    {
        $.fancybox("<div class='fastMessage'><h4>Регистрация прошла успешно!</h4><br>Спасибо за ваш интерес к магазину STOLNIK!</div>");
    }

    var newRegisterSuccess = $(".newRegisterSuccessInput").val();
    if(newRegisterSuccess == "y")
    {
        $.fancybox("<div class='fastMessage'><h4>На ваш e-mail отправлено сообщение!</h4><br>Пожалуйста пройдите по ссылке, указанной в письме для подтверждения регистрации.</div>");
    }
    ...
    (function() {
        $('.profile_block input[name="PERSONAL_PHONE"]').mask('9 (999) 999 9999');
    })();
    ...
    (function() {
        ...
        $('.b-carousel-novelty .scrollable').scrollable({
            ...
            // speed: 300,
            size: itemq,
            next: '.js-carousel-novelty__next',
            prev: '.js-carousel-novelty__prev'
        });
    })();
