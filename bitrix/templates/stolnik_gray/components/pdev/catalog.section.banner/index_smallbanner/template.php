...
<?foreach($arResult["ITEMS"] as $cell=>$arElement):?>
    ...
    <li class="item" id="<?=$this->GetEditAreaId($arElement['ID']);?>"><div class="item_in">
        <? $cfile=CFile::ResizeImageGet($arElement['DETAIL_PICTURE'], array('width'=>318, 'height'=>371), BX_RESIZE_IMAGE_PROPORTIONAL, true);?>
        <div class="preview"><a href="<?=$arElement["PROPERTIES"]["LINK"]["VALUE"]?>"><img src="<?=$cfile["src"]?>" width="318" height="371" alt=""></a></div>
