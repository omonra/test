...
$APPLICATION->SetAdditionalCSS($templateFolder.'/fontawesome/css/font-awesome.min.css', true);
...
?>
	<NOSCRIPT>
        ...
        <h1 class="b-page-title">Оформление заказа</h1>
<?
                                ...
                                <div class="bx-advantages">
                                    <table>
                                        <tr>
                                            ...
                                            <td class="text">
                                                Гарантия возврата товара в течение 14 дней после оплаты
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text">
                                                Бесплатная доставка по всей России<div style="font-size:0.8em">На заказы от 5000 руб. </div>
                                            </td>
                                        </tr>
