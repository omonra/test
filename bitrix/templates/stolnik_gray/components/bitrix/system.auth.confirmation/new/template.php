...
if($arResult["MESSAGE_CODE"] == "E06" && $_REQUEST["confirm_user_id"] > 0)
{
	$USER->Authorize($_REQUEST["confirm_user_id"]);
    SendUserInfo($_REQUEST["confirm_user_id"]);
	LocalRedirect("/?registerSuccess=y");
}
?>
...
<?elseif(!$USER->IsAuthorized()):?>
	<?$APPLICATION->IncludeComponent("bitrix:system.auth.authorize", "new", array());?>
<?endif?>