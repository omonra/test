...
if (is_array($arResult['MORE_PHOTO']) && count($arResult['MORE_PHOTO']) > 0) {
	foreach ($arResult['MORE_PHOTO'] as $picture) {
		...
		$arResult['PICTURE'][] = GetResizedPicture($picture['ID'], CATALOG_DETAIL_PICTURE_WIDTH, CATALOG_DETAIL_PICTURE_HEIGHT);
		$arResult['BIG_PICTURE'][] = GetResizedPicture($picture['ID'], CATALOG_DETAIL_BIG_PICTURE_WIDTH, CATALOG_DETAIL_BIG_PICTURE_HEIGHT);

	}
}
//
//echo "<pre>"; print_r($arResult['MORE_PHOTO']); echo "</pre>";
//echo "<pre>"; print_r($arResult['PICTURE']); echo "</pre>";
