...
if (strlen($arCurrentValues['IBLOCK_ID']) > 3 && substr($arCurrentValues['IBLOCK_ID'], 0, 2) == '={' && $arCurrentValues['IBLOCK_ID'][strlen($arCurrentValues['IBLOCK_ID']) - 1] == '}') {
	$iblockId = constant(substr($arCurrentValues['IBLOCK_ID'], 2, strlen($arCurrentValues['IBLOCK_ID']) - 3));
} else {
...
$arUserFields = $GLOBALS["USER_FIELD_MANAGER"]->GetUserFields("IBLOCK_".$iblockId."_SECTION");
