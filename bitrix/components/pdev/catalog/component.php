...
else
{
	...
	elseif(isset($arVariables["SECTION_ID"]) && intval($arVariables["SECTION_ID"]) > 0)
		$componentPage = "section";
	elseif(isset($arVariables["SECTION_CODE"]) && strlen($arVariables["SECTION_CODE"]) > 0 && $arVariables["SECTION_CODE"]!="toexclude")
		$componentPage = "section";
	else
		$componentPage = "sections";
...
if ($componentPage=="section" && isset($arVariables["SECTION_CODE"])) {
	if (in_array($arVariables["SECTION_CODE"], array('zhenskaya_obuv', 'zhenskaya_odezhda', 'muzhskaya_odezhda', 'muzhskaya_obuv')) ||
			$arVariables["SECTION_CODE"]==$section_men ||
			$arVariables["SECTION_CODE"]==$section_acc ||
			$arVariables["SECTION_CODE"]==$section_women
		) {
...
if (!is_array($arParams['PRICE_CODE']) || count($arParams['PRICE_CODE']) <= 0) {
	$arParams['PRICE_CODE'] = GetPriceCodes();
}
