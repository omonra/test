...
$MESS["CP_SBB_TPL_THEME_SITE"] = "Farbschema der Website benutzen (fόr bitrix.eshop)";
$MESS["CP_SBB_TPL_THEME_BLUE"] = "Blau (standardmδίig)";
$MESS["CP_SBB_TPL_THEME_GREEN"] = "Grόn";
